...
<span class="smallercopy_nav"><span class="smallercopy_nav_sel">General</span> | Reward | Location | Plan</span>
		...
		<?php echo $form->create('Merchant'); ?>
                  ...
                  <div class='smallercopy_err' style='color:red'><?php echo $form->input('business_name', array('label'=>false, 'class'=>'required validate-password-confirm', 'style'=>'width:217px','title'=>'Enter the same password for confirmation')); ?></div>
                  <div class="smallercopy_reg">Business Phone</div>
                  <div class='smallercopy_err' style='color:red'><?php echo $form->input('business_phone', array('label'=>false, 'class'=>'required validate-password-confirm', 'style'=>'width:217px','title'=>'Enter the same password for confirmation')); ?></div>
