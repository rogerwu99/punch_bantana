       <div id="beta" class="section-1">
		...
		<?php if ($user['latitude']!=0): 
				...
				?>
				<table><tr><th class="deals_td" colspan=2><? 
				if ($user['plan']==0){
				echo $form->input('text', array('type'=>'text','label'=>'Input Discount  ', 'class'=>'text_field_med','value'=>$dtext,'readonly' => 'readonly')); 
				} else {
				echo $form->input('text', array('type'=>'text','label'=>'Input Discount  ', 'class'=>'text_field_med','value'=>$dtext)); 
				}
